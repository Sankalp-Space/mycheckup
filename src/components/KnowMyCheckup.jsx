    ...
    <section className="py-20 px-4 relative">
      <div className="max-w-5xl mx-auto">
        <motion.div
          ...
          className="mb-12 pb-8 overflow-visible"
        >
          <h2 className="text-5xl font-bold bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent mb-8 leading-[1.25]">Know MyCheckup</h2>
